...
if (DEFINED ENV{FASTMATH})
    if($ENV{FASTMATH} STREQUAL "1")
        ...
        set(ECBUILD_CXX_FLAGS "${ECBUILD_CXX_FLAGS} -fp-model=fast")
    else()
        set(ECBUILD_CXX_FLAGS "${ECBUILD_CXX_FLAGS} -fp-model=strict")
    endif()
else()
    set(ECBUILD_CXX_FLAGS "${ECBUILD_CXX_FLAGS} -fp-model=strict")
endif()
...
if (DEFINED ENV{OPT_LEVEL})
    if($ENV{OPT_LEVEL} STREQUAL "0")
        set(ECBUILD_CXX_FLAGS "${ECBUILD_CXX_FLAGS} -O0")
    elseif ($ENV{OPT_LEVEL} STREQUAL "3")
        set(ECBUILD_CXX_FLAGS "${ECBUILD_CXX_FLAGS} -O3")
    endif()
else()
    set(ECBUILD_CXX_FLAGS "${ECBUILD_CXX_FLAGS} -O0")
endif()