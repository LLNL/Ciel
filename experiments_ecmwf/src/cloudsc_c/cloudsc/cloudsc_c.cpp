	      ...
	      double * __restrict v_pfhpsn)
{
  ...
  typedef double (*klon_vla)[klon];
  typedef double (*klev_klon_vla)[klev][klon];
  klon_vla pt = (klon_vla) v_pt;
  klon_vla pq = (klon_vla) v_pq;
  klon_vla tendency_cml_t = (klon_vla) v_tendency_cml_t;
  klon_vla tendency_cml_q = (klon_vla) v_tendency_cml_q;
  klon_vla tendency_cml_a = (klon_vla) v_tendency_cml_a;
  klev_klon_vla tendency_cml_cld = (klev_klon_vla) v_tendency_cml_cld;
  klon_vla tendency_tmp_t = (klon_vla) v_tendency_tmp_t;
  klon_vla tendency_tmp_q = (klon_vla) v_tendency_tmp_q;
  klon_vla tendency_tmp_a = (klon_vla) v_tendency_tmp_a;
  klev_klon_vla tendency_tmp_cld = (klev_klon_vla) v_tendency_tmp_cld;
  klon_vla tendency_loc_t = (klon_vla) v_tendency_loc_t;
  klon_vla tendency_loc_q = (klon_vla) v_tendency_loc_q;
  klon_vla tendency_loc_a = (klon_vla) v_tendency_loc_a;
  klev_klon_vla tendency_loc_cld = (klev_klon_vla) v_tendency_loc_cld;
  klon_vla pvfa = (klon_vla) v_pvfa;
  klon_vla pvfl = (klon_vla) v_pvfl;
  klon_vla pvfi = (klon_vla) v_pvfi;
  klon_vla pdyna = (klon_vla) v_pdyna;
  klon_vla pdynl = (klon_vla) v_pdynl;
  klon_vla pdyni = (klon_vla) v_pdyni;
  klon_vla phrsw = (klon_vla) v_phrsw;
  klon_vla phrlw = (klon_vla) v_phrlw;
  klon_vla pvervel = (klon_vla) v_pvervel;
  klon_vla pap = (klon_vla) v_pap;
  klon_vla paph = (klon_vla) v_paph;
  double (*plsm) = (double (*)) v_plsm;
  int (*ktype) = (int (*)) v_ktype;
  klon_vla plu = (klon_vla)v_plu;
  klon_vla plude = (klon_vla) v_plude;
  klon_vla psnde = (klon_vla) v_psnde;
  klon_vla pmfu = (klon_vla) v_pmfu;
  klon_vla pmfd = (klon_vla) v_pmfd;
  klon_vla pa = (klon_vla) v_pa;
  klev_klon_vla pclv = (klev_klon_vla) v_pclv;
  klon_vla psupsat = (klon_vla) v_psupsat;
  klon_vla plcrit_aer = (klon_vla) v_plcrit_aer;
  klon_vla picrit_aer = (klon_vla) v_picrit_aer;
  klon_vla pre_ice = (klon_vla) v_pre_ice;
  klon_vla pccn = (klon_vla) v_pccn;
  klon_vla pnice = (klon_vla) v_pnice;
  klon_vla pcovptot = (klon_vla) v_pcovptot;
  double (*prainfrac_toprfz) = (double (*)) v_prainfrac_toprfz;
  klon_vla pfsqlf = (klon_vla) v_pfsqlf;
  klon_vla pfsqif = (klon_vla) v_pfsqif;
  klon_vla pfcqnng = (klon_vla) v_pfcqnng;
  klon_vla pfcqlng = (klon_vla) v_pfcqlng;
  klon_vla pfsqrf = (klon_vla) v_pfsqrf;
  klon_vla pfsqsf = (klon_vla) v_pfsqsf;
  klon_vla pfcqrng = (klon_vla) v_pfcqrng;
  klon_vla pfcqsng = (klon_vla) v_pfcqsng;
  klon_vla pfsqltur = (klon_vla) v_pfsqltur;
  klon_vla pfsqitur = (klon_vla) v_pfsqitur;
  klon_vla pfplsl = (klon_vla) v_pfplsl;
  klon_vla pfplsn = (klon_vla) v_pfplsn;
  klon_vla pfhpsl = (klon_vla) v_pfhpsl;
  klon_vla pfhpsn = (klon_vla) v_pfhpsn;
  double zlcond1[klon];
  double zlcond2[klon];
  double zlevap;
  double zleros;
  ...
  //             0.  *** SET UP CONSTANTS ***
  //######################################################################
  zepsilon = 100.0 * std::numeric_limits<double>::epsilon();    // --------------------------------------------------------------
